...
make gcp_up WARM_MODELS="llama3.2:3b llama3.1:8b"  # allume API + LLM, deux GPU (~7-8 $/h) ; make gcp_eval_up pour éval + LLM
...
| **GCP** (composants, authentification, accès équipe) | [`setup/gcp.md`](docs/setup/gcp.md) · [`composants.md`](docs/gcp/composants.md) · [`cloudrun.md`](docs/gcp/cloudrun.md) · [`code-en-bucket.md`](docs/gcp/code-en-bucket.md) · [`infra-gpu.md`](docs/gcp/infra-gpu.md) · [`latence-predict.md`](docs/gcp/latence-predict.md) (temps de réponse mesurés) · [`auth.md`](docs/gcp/auth.md) · [`share.md`](docs/gcp/share.md) · [`aletheia-local.md`](docs/gcp/aletheia-local.md) (Aletheia local + Berlue sur GCP) |
