...
pipeline_selfcheck: ## Branche SelfCheckGPT seule : échantillonnage (K appels LLM) + score de divergence
	python -m berlue.pipeline.hurlu_berlu --until selfcheck --question "$(QUESTION)"

pipeline_rag: ## Branche RAG seule : un verdict par affirmation
